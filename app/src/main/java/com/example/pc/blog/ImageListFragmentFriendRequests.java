 ...
 */
public class ImageListFragmentFriendRequests extends AbsListViewBaseFragment implements AsyncResponse {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		phpHandler=new MyPHPHandler(getActivity(),"print_friend_requests");
		phpHandler.execute(UserID);
		phpHandler.delegate = this;
		View rootView = inflater.inflate(R.layout.activity_public_friend_reqeusts, container, false);
		listView = (ListView) rootView.findViewById(R.id.TheFriendRequestsListView);
		/*
	...
	private static class ImageAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				view = inflater.inflate(R.layout.custom_public_friend_request_row, parent, false);
				...
				holder.AddFriendButton=(Button)view.findViewById(R.id.AddFriendButton);
				holder.RemoveFriendButton=(Button)view.findViewById(R.id.RemoveFriendButton);
				view.setTag(holder);
			} else {
			...
			holder.AddFriendButton.setOnClickListener(
					new View.OnClickListener() {
						...
						public void onClick(View v) {
							myPHPHandler = new MyPHPHandler(activity, "accept_friend");
							myPHPHandler.execute(UserID, FriendItems.get(position).getFriendID());
							System.out.println("User ID  :  "+UserID+"   Friend ID  :   "+FriendItems.get(position).getFriendID());
			...
			holder.RemoveFriendButton.setOnClickListener(
					new View.OnClickListener() {
						@Override
						public void onClick(View v) {
							myPHPHandler = new MyPHPHandler(activity, "delete_friend_request");
							myPHPHandler .execute(UserID, FriendItems.get(position).getFriendID());
						}
					}
			);
